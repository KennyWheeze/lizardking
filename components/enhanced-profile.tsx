      ...
      <CardContent className="p-0">
        ...
        <div className="bg-gradient-to-r from-zinc-800/50 to-zinc-900/50 p-4 sm:p-6 flex flex-col items-center border-b border-zinc-800">
          <div className="flex flex-col sm:flex-col items-center w-full">
            <div className="relative w-24 h-24 sm:w-28 sm:h-28 rounded-full overflow-hidden mb-4 border-2 border-yellow-400/20 ring-4 ring-zinc-800/50">
              <Image
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-yellow-400 mb-1">{personalInfo.title}</p>
            ...
            <TabsList className="w-full bg-transparent border-b border-zinc-800 rounded-none h-auto p-0">
              <TabsTrigger
                ...
                className={`flex-1 rounded-none border-b-2 px-2 sm:px-4 py-2 text-xs sm:text-sm ${
                  activeTab === "about" ? "border-yellow-400 text-yellow-400" : "border-transparent text-zinc-400"
                }`}
              >
              ...
              <TabsTrigger
                value="contact"
                className={`flex-1 rounded-none border-b-2 px-2 sm:px-4 py-2 text-xs sm:text-sm ${
                  activeTab === "contact" ? "border-yellow-400 text-yellow-400" : "border-transparent text-zinc-400"
                }`}
              >
          ...
          <TabsContent value="contact" className="p-4 sm:p-6 space-y-4 focus:outline-none">
            <div className="space-y-4">
              <div className="flex items-start">
                <Mail className="w-5 h-5 mr-3 text-yellow-400 mt-0.5" />
                <div>
              ...
              <div className="flex items-start">
                <Phone className="w-5 h-5 mr-3 text-yellow-400 mt-0.5" />
                <div>
              ...
              <div className="flex items-start">
                <MapPin className="w-5 h-5 mr-3 text-yellow-400 mt-0.5" />
                <div>
