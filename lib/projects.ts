...
export const projects: Project[] = [
  {
    ...
    category: "eLearning",
    shortDescription:
      "Interactive, voiceover-friendly eLearning modules for First Aid, Electrical Safety, HIRAC.",
    description: [
  ...
  },
  {
    ...
    category: "HSSEQ",
    shortDescription:
      "End-to-end monthly safety campaigns and 30–45 min slide decks.",
    description: [
  ...
  },
  {
    ...
    shortDescription:
      "Comprehensive manuals with varied slide patterns and assessments.",
    description: [
